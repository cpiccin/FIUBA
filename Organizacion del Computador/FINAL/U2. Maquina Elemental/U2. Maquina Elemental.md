...
- CARGA (cargar un contenido en el AC)<br>
- ALMACENAMIENTO (enviar datos a memoria por el bus)<br>
- SUMA (sumar un dato a lo que haya en el AC)<br>
- LOGICAS (OR, AND, XOR) <br>
