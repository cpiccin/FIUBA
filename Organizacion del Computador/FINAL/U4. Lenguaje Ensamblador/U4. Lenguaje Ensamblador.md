...
Programa utilitario que combina uno a mas archivos de codigo objeto en un unico archivo que contiene codigo ejecutable. El linker resuelve las referencias a direcciones externas, es decir, aquellas referencias a funciones, variables o recursos que están definidos en otros módulos o bibliotecas. El linker asegura que todas estas referencias sean correctamente direccionadas, asignando las direcciones de memoria finales que serán utilizadas en tiempo de ejecución.
...
- Loading dinámico en tiempo de ejecución (hoy en dia, caso mas comun)
