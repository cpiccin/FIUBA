...
- **UAL:** tiene un registro particular, el acumulador (AC) en el cual, en abacus, se almacena el resultado de una operacion. La UAL puede realizar operaciones como
  ...
  * LOGICAS (OR, AND, XOR) 
- **UC:** se encarga de extraer y analizar las instrucciones. Tiene dos registros y el componente SI:
...
- **Memoria:** esta formada por celdas que tienen un contenido y una direccion. Tiene asociados dos registros:
